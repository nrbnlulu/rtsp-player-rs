...
import 'package:flutter_gstreamer/src/model/response.dart';
import 'package:flutter_gstreamer/src/rust/api/client.dart';
import 'package:flutter_gstreamer/src/rust/frb_generated.dart';
import 'package:flutter_gstreamer/src/rust/api/client.dart' as rust_client;
...
import 'package:flutter_gstreamer/src/rust/lib.dart' as rust_lib;
...
rust_error.flutter_gstreamerError fakeflutter_gstreamerError(String message) {
  return rust_error.flutter_gstreamerError
      .flutter_gstreamerUnknownError(message);
}

rust_error.flutter_gstreamerError fakeCancelError() {
  return const rust_error.flutter_gstreamerError.flutter_gstreamerCancelError();
}
