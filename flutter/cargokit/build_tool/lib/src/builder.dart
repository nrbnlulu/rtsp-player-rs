...
const _additionalEnv = {
  'RUSTFLAGS':
      r'--remap-path-prefix=$HOME/.cargo/=/.cargo/ --cfg reqwest_unstable',
};
...
String _getToolchainVersion(String fallback) {
  ...
  // Transform C:\Users\user\flutter_gstreamer\flutter_gstreamer\example\build\windows\x64\plugins\flutter_gstreamer\cargokit_build\tool
  // OR        C:\Users\user\flutter_gstreamer\flutter_gstreamer\example\build\flutter_gstreamer\build\build_tool
  // to
  // C:\Users\user\flutter_gstreamer\flutter_gstreamer\example
  // taking the parent of the right most "build" directory to get the project root,
  // while removing the "flutter_gstreamer/build/build_tool" suffix
  final buildIndex = workingDirectory
      .replaceAll('flutter_gstreamer/build/build_tool', '')
      .lastIndexOf('/build/');
  if (buildIndex != -1) {
